...
func (au *ArticleUpdate) SetCid(i int32) *ArticleUpdate {
	au.mutation.ResetCid()
	au.mutation.SetCid(i)
	return au
}

// AddCid adds i to the "cid" field.
func (au *ArticleUpdate) AddCid(i int32) *ArticleUpdate {
	au.mutation.AddCid(i)
	return au
}
...
func (au *ArticleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.Cid(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: article.FieldCid,
		})
	}
	if value, ok := au.mutation.AddedCid(); ok {
...
// SetCid sets the "cid" field.
func (auo *ArticleUpdateOne) SetCid(i int32) *ArticleUpdateOne {
	auo.mutation.ResetCid()
	auo.mutation.SetCid(i)
	return auo
}

// AddCid adds i to the "cid" field.
func (auo *ArticleUpdateOne) AddCid(i int32) *ArticleUpdateOne {
	auo.mutation.AddCid(i)
	return auo
}
...
func (auo *ArticleUpdateOne) sqlSave(ctx context.Context) (_node *Article, err error) {
	...
	if value, ok := auo.mutation.Cid(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: article.FieldCid,
	...
	if value, ok := auo.mutation.AddedCid(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt32,
			Value:  value,
			Column: article.FieldCid,
