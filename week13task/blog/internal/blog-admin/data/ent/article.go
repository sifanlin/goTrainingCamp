...
func (*Article) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case article.FieldID, article.FieldCid:
			values[i] = new(sql.NullInt64)
		case article.FieldTitle, article.FieldDesc, article.FieldContent, article.FieldImg:
...
func (a *Article) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", a.Cid))
