...
func (au *ArticleUpdate) SetCid(s string) *ArticleUpdate {
	au.mutation.SetCid(s)
	return au
}
...
// SetCid sets the "cid" field.
func (auo *ArticleUpdateOne) SetCid(s string) *ArticleUpdateOne {
	auo.mutation.SetCid(s)
	return auo
}
