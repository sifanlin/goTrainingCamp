...
import (
	"blog/internal/blog-interface/data/ent/article"
	"blog/internal/blog-interface/data/ent/category"
	"blog/internal/blog-interface/data/ent/predicate"
	"blog/internal/blog-interface/data/ent/profile"
	"blog/internal/blog-interface/data/ent/user"
	"context"
	"fmt"
	"sync"
	"time"
...
func (m *ArticleMutation) SetCid(s string) {
	m.cid = &s
}

// Cid returns the value of the "cid" field in the mutation.
func (m *ArticleMutation) Cid() (r string, exists bool) {
	v := m.cid
	if v == nil {
		return
	}
...
// If the Article object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ArticleMutation) OldCid(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
